       ...
       char **argv)
{
    ...
    long double scale = strtod (argv[2], NULL);
    ...
    // Read global info
    long int point_p = -1, line_p = -1, poly_p = -1;
    long int dpi = -1;
    long int version = -1;
    ...
    do
    {
        ...
        pal::Layer *layer = pal->addLayer (name, (long double)-1, (long double)-1, arrange, unit, priority, isObstacle, true, true);
        delete[] name;
        long int it = 1;
        do
        {
