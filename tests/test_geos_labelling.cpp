             ...
             int num)
{
    ...
    {
        std::string wtk3 = "POLYGON ((4000 1300, 6000 1300, 6000 1800, 4000 1800, 4000 1300))";
    ...
    {
        std::string wtk3 = "POLYGON ((8044 746, 9110 746, 9110 1294, 8044 1294, 8044 746))";
    ...
    {
        std::string wtk3 = "POLYGON ((9601 779, 10365 779, 10365 1577, 9601 1577, 9601 779))";
    ...
    }
    {
        ...
        layer->setFeatureLabelSize (id.c_str (), (double) 121, (double) 69, 1, (double) 0.785398163397, 1, 0);
    }
    {
        std::string wtk = "POLYGON ((9120 1226, 9186 1226, 9186 1244, 9120 1244, 9120 1226))";
        ...
        layer2->setFeatureLabelSize (id.c_str (), (double) 66, (double) 18, 0, (double) 0.785398163397, 1, 0);
    }
    {
        ...
        layer->setFeatureDistlabel (id.c_str (), 42);
        layer->setFeatureLabelSize (id.c_str (), (double) 136, (double) 69, 1, (double) 0.785398163397, 1,0);
    }
    {
        std::string wtk = "POLYGON ((3593 1412, 3659 1412, 3659 1430, 3593 1430, 3593 1412))";
    ...
    // A1 [2022-05-05 13:05:38,284]: ERROR Stitching_Labels getGeosGeometry 2086
    {
        ...
        layer->setFeatureLabelSize (id.c_str (), (double) 159, (double) 81, 0, (double) 2.35619449019,1, 0);
    }
    {
        std::string wtk = "POLYGON ((10870 1017, 10936 1017, 10936 1035, 10870 1035, 10870 1017))";
        ...
        layer2->registerFeature (id.c_str (), geom, (double) 66, (double) 18);
        layer2->setFeatureDistlabel (id.c_str (), 0);
        layer2->setFeatureLabelSize (id.c_str (), (double) 66, (double) 18, 1, (double) 5.49778714378,1, 0);
    }
    {
        ...
        layer->setFeatureDistlabel (id.c_str (), 42);
        layer->setFeatureLabelSize (id.c_str (), (double) 123, (double) 69, 1, (double) 0.785398163397, 1,1);
    }
    {
        std::string wtk = "POLYGON ((10841 1183, 10907 1183, 10907 1201, 10841 1201, 10841 1183))";
        ...
        layer2->registerFeature (id.c_str (), geom, (double) 66, (double) 18);
        layer2->setFeatureDistlabel (id.c_str (), 0);
        layer2->setFeatureLabelSize (id.c_str (), (double) 66, (double) 18, 0, (double) 0.785398163397,1, 1);
    }
    {
        ...
        layer->setFeatureLabelSize (id.c_str (), (double) 214, (double) 112, 0, (double) 2.35619449019, 1, 0);
    }
    {
        std::string wtk = "POLYGON ((13605 1110, 13717 1110, 13717 1140, 13605 1140, 13605 1110))";
        ...
        layer2->setFeatureDistlabel (id.c_str (), 0);
        layer2->setFeatureLabelSize (id.c_str (), (double) 112, (double) 30, 1, (double) 5.49778714378,1, 0);
    }
    {
        ...
        layer->setFeatureLabelSize (id.c_str (), (double) 193, (double) 100, 1, (double) 0.785398163397, 1,0);
    }
    {
        // A1 [2022-05-05 13:05:38,285]: ERROR Stitching_Labels getGeosGeometry 2015ZonaAvion
        std::string wtk = "POLYGON ((2101 1179, 2167 1179, 2167 1197, 2101 1197, 2101 1179))";
    ...
    }
    {
        ...
        layer->registerFeature (id.c_str (), geom, (double) 121, (double) 69);
        layer->setFeatureDistlabel (id.c_str (), 42);
        layer->setFeatureLabelSize (id.c_str (), (double) 121, (double) 69, 0, (double) 2.35619449019,1, 0);
    }
    {
        std::string wtk = "POLYGON ((6426 1378, 6492 1378, 6492 1396, 6426 1396, 6426 1378))";
    ...
    }
    {
        ...
        layer->setFeatureDistlabel (id.c_str (), 42);
        layer->setFeatureLabelSize (id.c_str (), (double) 130, (double) 69, 0, (double) 2.35619449019, 1,0);
    }
    {
        std::string wtk = "POLYGON ((13867 1401, 13933 1401, 13933 1419, 13867 1419, 13867 1401))";
    ...
    }
    {
        ...
        layer->setFeatureLabelSize (id.c_str (), (double) 221, (double) 111, 0, (double) 2.35619449019, 1,0);
    }
    {
        std::string wtk = "POLYGON ((1595 1238, 1661 1238, 1661 1256, 1595 1256, 1595 1238))";
    ...
    }
    {
        ...
        layer->setFeatureDistlabel (id.c_str (), 42);
        layer->setFeatureLabelSize (id.c_str (), (double) 127, (double) 69, 1, (double) 0.785398163397, 1,0);
    }
    {
        std::string wtk = "POLYGON ((5801 1082, 5867 1082, 5867 1100, 5801 1100, 5801 1082))";
    ...
    }
    {
        ...
        layer->setFeatureLabelSize (id.c_str (), (double) 25, (double) 10, 0, (double) 5.49778714378, 1,0);
    }
    {
        std::string wtk = "POLYGON ((10946 2546, 11066 2546, 11066 2578, 10946 2578, 10946 2546))";
        ...
        layer2->setFeatureDistlabel (id.c_str (), 0);
        layer2->setFeatureLabelSize (id.c_str (), (double) 121, (double) 33, 1, (double) 5.49778714378, 1,0);
    }
    {
    ...
    {
        std::string wtk = "POLYGON ((12847 1702, 12913 1702, 12913 1720, 12847 1720, 12847 1702))";
    ...
    {
        std::string wtk = "POLYGON ((7377 1425, 7443 1425, 7443 1443, 7377 1443, 7377 1425))";
    ...
    }
    {
        ...
        layer->setFeatureDistlabel (id.c_str (), 42);
        layer->setFeatureLabelSize (id.c_str (), (double) 126, (double) 69, 0, (double) 2.35619449019, 1,0);
    }
    {
        std::string wtk = "POLYGON ((689 1147, 755 1147, 755 1165, 689 1165, 689 1147))";
    ...
    }
    {
        ...
        layer->setFeatureLabelSize (id.c_str (), (double) 189, (double) 104, 1, (double) 0.785398163397,1, 0);
    }
    {
        std::string wtk = "POLYGON ((12746 1241, 12860 1241, 12860 1271, 12746 1271, 12746 1241))";
        ...
        layer2->setFeatureDistlabel (id.c_str (), 0);
        layer2->setFeatureLabelSize (id.c_str (), (double) 115, (double) 31, 0, (double) 0.785398163397, 1,0);
    }
    // A1 [2022-05-05 13:05:38,287]: ERROR Stitching_Labels getGeosGeometry 2079
    {
        ...
        layer->setFeatureDistlabel (id.c_str (), 42);
        layer->setFeatureLabelSize (id.c_str (), (double) 128, (double) 69, 1, (double) 0.785398163397, 1,0);
    }
    {
        // A1 [2022-05-05 13:05:38,287]: ERROR Stitching_Labels getGeosGeometry 2079ZonaAvion
        std::string wtk = "POLYGON ((6838 1141, 6904 1141, 6904 1159, 6838 1159, 6838 1141))";
    ...
    // A1 [2022-05-05 13:05:38,287]: ERROR Stitching_Labels getGeosGeometry 2075
    {
        ...
        layer->registerFeature (id.c_str (), geom, (double) 127, (double) 69);
        layer->setFeatureDistlabel (id.c_str (), 42);
        layer->setFeatureLabelSize (id.c_str (), (double) 127, (double) 69, 0, (double) 2.35619449019, 1,0);
    }
    {
        // A1 [2022-05-05 13:05:38,287]: ERROR Stitching_Labels getGeosGeometry 2075ZonaAvion
        std::string wtk = "POLYGON ((8253 1627, 8319 1627, 8319 1645, 8253 1645, 8253 1627))";
    ...
    // A1 [2022-05-05 13:05:38,287]: ERROR Stitching_Labels getGeosGeometry 2074
    {
        ...
        layer->setFeatureDistlabel (id.c_str (), 42);
        layer->setFeatureLabelSize (id.c_str (), (double) 135, (double) 69, 0, (double) 2.35619449019, 1,0);
    }
    {
        // A1 [2022-05-05 13:05:38,287]: ERROR Stitching_Labels getGeosGeometry 2074ZonaAvion
        std::string wtk = "POLYGON ((4475 1931, 4541 1931, 4541 1949, 4475 1949, 4475 1931))";
    ...
    }
    {
        ...
        std::string wtk = "POLYGON ((9910 1899, 9976 1899, 9976 1917, 9910 1917, 9910 1899))";
    ...
    // A1 [2022-05-05 13:05:38,288]: ERROR Stitching_Labels getGeosGeometry 1975
    {
        ...
        layer->setFeatureLabelSize (id.c_str (), (double) 181, (double) 96, 1, (double) 5.49778714378, 1,0);
    }
    {
        // A1 [2022-05-05 13:05:38,288]: ERROR Stitching_Labels getGeosGeometry 1975ZonaAvion
        std::string wtk = "POLYGON ((5533 1241, 5599 1241, 5599 1259, 5533 1259, 5533 1241))";
    ...
    }
    {
        ...
        std::string wtk = "POLYGON ((12174 3217, 12286 3217, 12286 3247, 12174 3247, 12174 3217))";
    ...
    }
    {
        ...
        std::string wtk = "POLYGON ((13576 2647, 13688 2647, 13688 2677, 13576 2677, 13576 2647))";
    ...
    // A1 [2022-05-05 13:05:38,288]: ERROR Stitching_Labels getGeosGeometry 2050
    {
        ...
        layer->setFeatureDistlabel (id.c_str (), 42);
        layer->setFeatureLabelSize (id.c_str (), (double) 124, (double) 69, 1, (double) 3.92699081699, 1,0);
    }
    {
        // A1 [2022-05-05 13:05:38,288]: ERROR Stitching_Labels getGeosGeometry 2050ZonaAvion
        std::string wtk = "POLYGON ((9681 1021, 9747 1021, 9747 1039, 9681 1039, 9681 1021))";
    ...
    }
    {
        ...
        std::string wtk = "POLYGON ((4346 2057, 4412 2057, 4412 2075, 4346 2075, 4346 2057))";
...
//	}
    ...
    int val = 15360;
    std::string wtk = std::string ("POINT (").append (std::to_string (val)).append (std::string (" 2066)"));
    ...
    layer->registerFeature (id.c_str (), geom, (double) 127, (double) 69);
    layer->setFeatureDistlabel (id.c_str (), 42);
    layer->setFeatureLabelSize (id.c_str (), (double) 127, (double) 69, 1, (double) 2.35619449019, 1,0);
...
//	int val = 15359;
    for (int var = 0; var < 100; ++var)
    {
        ...
        {
            if (std::string (front->getLayerName ()).compare ("main") == 0 && std::string (front->getFeatureId ()).compare ("MOVE") == 0)
            {
...
//                        int corelationId = ((DatoTrazaRadar*) (((*it)->getGeometry ())))->getCorrelationId ();
                ...
                layer->setFeatureLabelSize (front->getFeatureId (), (double) 127, (double) 69, 1, (double) front->getAlphaPAu (),(double) front->getAlphaPAuH (), 0);
                std::cout << "" << front->getFeatureId () << "  X " << front->getX (0) << " " << front->getX (1) << " " << front->getX (2) << " " << front->getX (3) << " Y " << front->getY (0) << " "
                        << front->getY (1) << " " << front->getY (2) << " " << front->getY (3) << "\n";
                for (int var = 0; var < 4; ++var)
                {
                    if (front->getX (var) > 15360)
                    {
                        std::cout << "############# " << front->getFeatureId () << "  X " << front->getX (0) << " " << front->getX (1) << " " << front->getX (2) << " " << front->getX (3) << " Y "
                                << front->getY (0) << " " << front->getY (1) << " " << front->getY (2) << " " << front->getY (3) << "\n";
                        break;
                    }
                }
    ...
    std::cout << " pal->labeller size: " << labels->size () << "geoms " << geoms.size () << " getNbLabelledObjects " << stats->getNbLabelledObjects () << " getNbObjects " << stats->getNbObjects ()
            << "\n";
...
//    std::cout << "   "<<stats->getLayerName("mainA") <<" getLayerNbLabelledObjects " << stats->getLayerNbLabelledObjects("mainA")<<" getLayerNbObjects "<<  stats->getLayerNbObjects("mainA")<<"\n";
    ...
    std::cout << " pal->labeller2 size: " << labels2->size () << "geoms " << geoms.size () << " getNbLabelledObjects " << stats->getNbLabelledObjects () << " getNbObjects " << stats->getNbObjects ()
            << "\n";
