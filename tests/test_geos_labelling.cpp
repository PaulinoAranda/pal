              ...
              int num)
{
    ...
    layer->setFeatureLabelSize (id.c_str(), (double)121, (double)69,1,(double)0.785398163397,0);
    }
    {
    ...
    layer2->setFeatureLabelSize (id.c_str(), (double)66,(double)18,0, (double)0.785398163397,0);
    }
    {
    ...
    layer->setFeatureDistlabel (id.c_str(),42);
    layer->setFeatureLabelSize (id.c_str(), (double)136, (double)69,1,(double)0.785398163397,0);
    }
    {
  ...
  // A1 [2022-05-05 13:05:38,284]: ERROR Stitching_Labels getGeosGeometry 2086
    ...
    layer->setFeatureLabelSize (id.c_str(), (double)159, (double)81,0,(double)2.35619449019,0);
    }
    {
    ...
    layer2->registerFeature (id.c_str(), geom, (double)66,(double)18);
    layer2->setFeatureDistlabel (id.c_str(), 0);
    layer2->setFeatureLabelSize (id.c_str(), (double)66,(double)18,1, (double)5.49778714378,0);
    }
    {
    ...
    layer->setFeatureDistlabel (id.c_str(),42);
    layer->setFeatureLabelSize (id.c_str(), (double)123, (double)69,1,(double)0.785398163397,1);
    }
    {
    ...
    layer2->registerFeature (id.c_str(), geom, (double)66,(double)18);
    layer2->setFeatureDistlabel (id.c_str(), 0);
    layer2->setFeatureLabelSize (id.c_str(), (double)66,(double)18,0, (double)0.785398163397,1);
    }
    {
    ...
    layer->setFeatureLabelSize (id.c_str(), (double)214, (double)112,0,(double)2.35619449019,0);
    }
    {
    ...
    layer2->setFeatureDistlabel (id.c_str(), 0);
    layer2->setFeatureLabelSize (id.c_str(), (double)112,(double)30,1, (double)5.49778714378,0);
    }
    {
    ...
    layer->setFeatureLabelSize (id.c_str(), (double)193, (double)100,1,(double)0.785398163397,0);
    }
    {
  // A1 [2022-05-05 13:05:38,285]: ERROR Stitching_Labels getGeosGeometry 2015ZonaAvion
    ...
    layer->registerFeature (id.c_str(), geom, (double)121, (double)69);
    layer->setFeatureDistlabel (id.c_str(),42);
    layer->setFeatureLabelSize (id.c_str(), (double)121, (double)69,0,(double)2.35619449019,0);
    }
    {
    ...
    layer->setFeatureDistlabel (id.c_str(),42);
    layer->setFeatureLabelSize (id.c_str(), (double)130, (double)69,0,(double)2.35619449019,0);
    }
    {
    ...
    layer->setFeatureLabelSize (id.c_str(), (double)221, (double)111,0,(double)2.35619449019,0);
    }
    {
    ...
    layer->setFeatureDistlabel (id.c_str(),42);
    layer->setFeatureLabelSize (id.c_str(), (double)127, (double)69,1,(double)0.785398163397,0);
    }
    {
    ...
    layer->setFeatureLabelSize (id.c_str(), (double)25, (double)10,0,(double)5.49778714378,0);
    }
    {
    ...
    layer2->setFeatureDistlabel (id.c_str(), 0);
    layer2->setFeatureLabelSize (id.c_str(), (double)121,(double)33,1, (double)5.49778714378,0);
    }
    {
    ...
    layer->setFeatureDistlabel (id.c_str(),42);
    layer->setFeatureLabelSize (id.c_str(), (double)126, (double)69,0,(double)2.35619449019,0);
    }
    {
    ...
    layer->setFeatureLabelSize (id.c_str(), (double)189, (double)104,1,(double)0.785398163397,0);
    }
    {
    ...
    layer2->setFeatureDistlabel (id.c_str(), 0);
    layer2->setFeatureLabelSize (id.c_str(), (double)115,(double)31,0, (double)0.785398163397,0);
    }
  // A1 [2022-05-05 13:05:38,287]: ERROR Stitching_Labels getGeosGeometry 2079
    ...
    layer->setFeatureDistlabel (id.c_str(),42);
    layer->setFeatureLabelSize (id.c_str(), (double)128, (double)69,1,(double)0.785398163397,0);
    }
    {
  ...
  // A1 [2022-05-05 13:05:38,287]: ERROR Stitching_Labels getGeosGeometry 2075
    ...
    layer->registerFeature (id.c_str(), geom, (double)127, (double)69);
    layer->setFeatureDistlabel (id.c_str(),42);
    layer->setFeatureLabelSize (id.c_str(), (double)127, (double)69,0,(double)2.35619449019,0);
    }
    {
  ...
  // A1 [2022-05-05 13:05:38,287]: ERROR Stitching_Labels getGeosGeometry 2074
    ...
    layer->setFeatureDistlabel (id.c_str(),42);
    layer->setFeatureLabelSize (id.c_str(), (double)135, (double)69,0,(double)2.35619449019,0);
    }
    {
  ...
  // A1 [2022-05-05 13:05:38,288]: ERROR Stitching_Labels getGeosGeometry 1975
    ...
    layer->setFeatureLabelSize (id.c_str(), (double)181, (double)96,1,(double)5.49778714378,0);
    }
    {
  ...
  // A1 [2022-05-05 13:05:38,288]: ERROR Stitching_Labels getGeosGeometry 2050
    ...
    layer->setFeatureDistlabel (id.c_str(),42);
    layer->setFeatureLabelSize (id.c_str(), (double)124, (double)69,1,(double)3.92699081699,0);
    }
    {
