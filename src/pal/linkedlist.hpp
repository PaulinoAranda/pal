...
namespace pal
{
    ...
    template< class Type>
        class LinkedList
        {
            ...
            public:
                ...
                (*compare) ( Type a,
                             Type b)) :
                        first (NULL), last (NULL), s (0), compare (compare)
                {
                }
                ;
                /**
    ...
    template< class Type>
        void
        LinkedList< Type>::push_back ( Type item)
        {
            if (s == 0)
            {
    ...
    template< class Type>
        void
        LinkedList< Type>::push_front ( Type item)
        {
    ...
    template< class Type>
        bool
        LinkedList< Type>::isIn ( Type item)
        {
            Cell< Type> *cur = first;
    ...
    template< class Type>
        void
        LinkedList< Type>::remove ( Type item)
        {
            Cell< Type> *p = first;
            Cell< Type> *q;
    ...
    template< class Type>
        Cell< Type>*
        LinkedList< Type>::search ( Type item)
        {
            Cell< Type> *p = first;
