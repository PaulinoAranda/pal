...
// This is a Hash table that maps string keys to objects of type Data
    template< typename Data>
        class HashTable
        {
            ...
            public:
                HashTable ( long int tableSize);
                ~HashTable ();
                bool
                insertItem ( const char *key,
                             Data data);
                Data*
                find ( const char *key);
                bool
    ...
    template< typename Data>
        unsigned long
        HashTable< Data>::hash ( const char *key)
        {
    ...
    template< typename Data>
        HashTable< Data>::HashTable ( long int tableSize) :
                tableSize (tableSize)
        {
    ...
    template< class Data>
        bool
        hashEntryCompare ( HashTableEntry< Data> *a,
                           HashTableEntry< Data> *b)
        {
    ...
    template< typename Data>
        bool
        HashTable< Data>::insertItem ( const char *key,
                                       Data data)
        {
    ...
    template< typename Data>
        Data*
        HashTable< Data>::find ( const char *key)
        {
            unsigned long i = hash (key);
...
//			std::cout << "# find cell NULL " << i << std::endl;
    ...
    template< typename Data>
        bool
        HashTable< Data>::removeElement ( const char *key)
        {
...
/*template <typename Data>
 ...
 long int _currentBucket; // Current bucket that is being iterated
