...
namespace pal
{
    ...
    class PalStat
    {
        ...
        private:
            long int nbObjects;
            long int nbLabelledObjects;

            long int nbLayers;

            char **layersName;     //[nbLayers]
            long int *layersNbObjects;     // [nbLayers]
            long int *layersNbLabelledObjects;     // [nbLayers]
